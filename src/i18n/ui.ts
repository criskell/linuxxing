...
export const ui = {
  en: {
    ...
    'study.backToOverview': 'Back to the full roadmap',
    'study.relatedHeading': 'Related cards',
    'study.keyPointsHeading': 'Worth remembering',
    'study.commandsHeading': 'Commands to know',
    'study.savedConfirmation': 'Saved. This card will resurface when it is due again.',
    ...
    'lab.ready': 'Root shell ready',
    'lab.restart': 'Restart the machine',
    'lab.idleTerminal': 'The terminal appears here once the machine boots. The download weighs about 7 MB.',
    'lab.terminalBanner': 'linuxxing lab, BusyBox on Linux 5.6.\nYou are root. Run dmesg for the kernel log.',
    'lab.exercisesHeading': 'Exercises',
    'lab.progress': (solved: number, total: number) => `${solved} of ${total} exercises solved`,
    'lab.prepare': 'Set up',
    'lab.check': 'Check my work',
    'lab.hint': 'Hint',
    'lab.solution': 'Solution',
    'lab.typeSolution': 'Type it into the shell',
    'lab.solved': 'Solved',
    'lab.resultPassed': 'Solved. Every check passed against the running machine.',
    'lab.resultBusy': 'Leave the shell sitting at a prompt first, so quit vi or stop the running program.',
    ...
    'lab.criteriaHeading': 'What the lab checks',
    'lab.checking': 'Checking against the machine',
    'lab.resultPartial': (passed: number, total: number) =>
      `${passed} of ${total} checks passed. The ones still missing are marked above.`,
    'lab.sandboxWhatIsInside': 'What the sandbox puts on the machine',
  ...
  pt: {
    ...
    'study.backToOverview': 'Voltar para a trilha completa',
    'study.relatedHeading': 'Cartões relacionados',
    'study.keyPointsHeading': 'Vale lembrar',
    'study.commandsHeading': 'Comandos para conhecer',
    'study.savedConfirmation': 'Salvo. Este cartão volta a aparecer quando estiver pendente de novo.',
    ...
    'lab.ready': 'Shell de root pronto',
    'lab.restart': 'Reiniciar a máquina',
    'lab.idleTerminal': 'O terminal aparece aqui assim que a máquina liga. O download tem cerca de 7 MB.',
    'lab.terminalBanner':
      'laboratório linuxxing, BusyBox no Linux 5.6.\nVocê é root. Rode dmesg para ver o log do kernel.',
    'lab.exercisesHeading': 'Exercícios',
    'lab.progress': (solved: number, total: number) => `${solved} de ${total} exercícios resolvidos`,
    'lab.prepare': 'Preparar',
    'lab.check': 'Verificar',
    'lab.hint': 'Dica',
    'lab.solution': 'Solução',
    'lab.typeSolution': 'Digitar no shell',
    'lab.solved': 'Resolvido',
    'lab.resultPassed': 'Resolvido. Todos os critérios passaram na máquina em execução.',
    'lab.resultBusy': 'Deixe o shell parado no prompt antes, então saia do vi ou encerre o programa em execução.',
    ...
    'lab.criteriaHeading': 'O que o laboratório confere',
    'lab.checking': 'Conferindo na máquina',
    'lab.resultPartial': (passed: number, total: number) =>
      `${passed} de ${total} critérios atendidos. Os que faltam estão marcados acima.`,
    'lab.sandboxWhatIsInside': 'O que o sandbox coloca na máquina',
