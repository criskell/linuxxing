...
export const ui = {
  en: {
    ...
    'study.tagline':
      'Flashcards for every LPIC-1 exam objective, reviewed with spaced repetition and saved right in your browser.',
    'study.reviewAll': 'Review everything due',
    'study.topicCards': (count: number) => `${count} cards`,
    'study.topicDue': (count: number) => `${count} due for review`,
    'study.startTopic': 'Study this topic',
    'study.showAnswer': 'Show answer',
    'study.grade.again': 'Again',
    'study.grade.hard': 'Hard',
    'study.grade.good': 'Good',
    'study.grade.easy': 'Easy',
    'study.sessionProgress': (current: number, total: number) => `Card ${current} of ${total}`,
    'study.sessionCompleteTitle': 'Session complete',
    'study.sessionCompleteBody': 'Nice work. Come back later for the next batch of reviews.',
    'study.backToRoadmap': 'Back to the roadmap',
    'study.nothingDue': 'Nothing due right now.',
  ...
  pt: {
    ...
    'study.tagline':
      'Cartões para cada objetivo do exame LPIC-1, revisados com repetição espaçada e salvos direto no seu navegador.',
    'study.reviewAll': 'Revisar tudo que está pendente',
    'study.topicCards': (count: number) => `${count} cartões`,
    'study.topicDue': (count: number) => `${count} pendentes de revisão`,
    'study.startTopic': 'Estudar este tópico',
    ...
    'study.sessionProgress': (current: number, total: number) => `Cartão ${current} de ${total}`,
    'study.sessionCompleteTitle': 'Sessão concluída',
    'study.sessionCompleteBody': 'Bom trabalho. Volte mais tarde para a próxima leva de revisões.',
    'study.backToRoadmap': 'Voltar para a trilha',
    'study.nothingDue': 'Nada pendente no momento.',
