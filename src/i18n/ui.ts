...
export const ui = {
  en: {
    ...
    'lab.terminalBanner': 'linuxxing lab, BusyBox 1.31 on Linux 5.6, you are root. Run dmesg to read the kernel log.',
    ...
    'lab.solved': 'Solved',
    'lab.resultPassed': 'Solved. The machine matches what the exercise asked for.',
    'lab.resultFailed': 'Not there yet. Read the hint and look at what the machine actually has.',
  ...
  pt: {
    ...
    'lab.terminalBanner':
      'laboratório linuxxing, BusyBox 1.31 sobre Linux 5.6, você é root. Rode dmesg para ler o log do kernel.',
    ...
    'lab.resultPassed': 'Resolvido. A máquina está do jeito que o exercício pediu.',
    'lab.resultFailed': 'Ainda não. Leia a dica e olhe o que a máquina tem de fato.',
